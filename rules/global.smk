...
def smc_split_input(wildcards):
    ...
    pop1_input = expand("models/smc_estimate_input/{population}.{distinguished_ind}.{chr}.smc.gz", population=pops[0], distinguished_ind=distind_dict[pops[0]], chr=CHR)
    pop2_input = expand("models/smc_estimate_input/{population}.{distinguished_ind}.{chr}.smc.gz", population=pops[1], distinguished_ind=distind_dict[pops[1]], chr=CHR)
    joint_input12 = expand("models/smc_split_input/{pop_pair}_12.{distinguished_ind}.{chr}.smc.gz", pop_pair = wildcards.pop_pair, distinguished_ind=distind_dict[pops[0]], chr = CHR)
    joint_input21 = expand("models/smc_split_input/{pop_pair}_21.{distinguished_ind}.{chr}.smc.gz", pop_pair = wildcards.pop_pair, distinguished_ind=distind_dict[pops[1]], chr = CHR)
...
def smc_split_bootstrap_input(wildcards):
    ...
    pop1_input = expand('models/smc_estimate_bootstrap_input/{population}_{distinguished_ind}_rep_{n_bootstrap}/bootstrap_chr{boot_chr}.gz',  population=pops[0], distinguished_ind=distind_dict[pops[0]],
    n_bootstrap = wildcards.n_bootstrap, boot_chr = range(1,10))
    pop2_input = expand('models/smc_estimate_bootstrap_input/{population}_{distinguished_ind}_rep_{n_bootstrap}/bootstrap_chr{boot_chr}.gz',  population=pops[1], distinguished_ind=distind_dict[pops[1]],
    n_bootstrap = wildcards.n_bootstrap, boot_chr = range(1,10))
    joint_input12 = expand("models/smc_split_bootstrap_input/{pop_pair}_12.{distinguished_ind}_rep_{n_bootstrap}/bootstrap_chr{boot_chr}.gz", pop_pair = wildcards.pop_pair, distinguished_ind=distind_dict[pops[0]], n_bootstrap = wildcards.n_bootstrap, boot_chr = range(1,10))
    joint_input21 = expand("models/smc_split_bootstrap_input/{pop_pair}_21.{distinguished_ind}_rep_{n_bootstrap}/bootstrap_chr{boot_chr}.gz", pop_pair = wildcards.pop_pair, distinguished_ind=distind_dict[pops[1]], n_bootstrap = wildcards.n_bootstrap, boot_chr = range(1,10))
    return models + pop1_input + pop2_input + joint_input12 + joint_input21
